...
const ConcessaoTREstudante = ({ selectedPerson, onBack, onSuccess }) => {
  ...
  const gerarProcessId = async () => {
    ...
    try {
      ...
      const novoId = `ConcessaoTREstudante-${timestamp}-${randomHex}`;
      ...
      <Paper elevation={3} sx={{ p: 3, borderRadius: 2, backgroundColor: 'white' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
          <Typography variant="h5" sx={{ flexGrow: 1 }}>
            ...
            Concessão de TR para Estudante
          </Typography>
        </Box>
...
export default ConcessaoTREstudante; 